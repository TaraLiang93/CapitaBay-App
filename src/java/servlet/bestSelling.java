 ...
 * @author root
 */
@WebServlet(name = "bestSelling", urlPatterns = {"/bestSelling"})
public class bestSelling extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("bestSellerList", result);
        }catch (SQLException ex) {
            Logger.getLogger(CustomerMailingList.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(CustomerMailingList.class.getName()).log(Level.SEVERE, null, ex);
        }   
         RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/bestSelling.jsp");

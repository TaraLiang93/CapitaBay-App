...
public class buyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String account = request.getParameter("stock-account");
        String otype = request.getParameter("order-type");
        String essn = request.getParameter("employee");
        ...
        String query;
        if(otype.equals("market")) {
            query = "call addMarket(" + userBean.getSocialSecurityNumber() + ", " + num + ", '" + cal.getHourOfDay() + ":" + cal.getMinuteOfHour() + ":" + cal.getSecondOfMinute() +"'," + essn + "," + account + ", '" + ss + "', '" + cal.getYear() + "-" + cal.getMonthOfYear() + "-" + cal.getDayOfMonth() + "', 'buy');";
        } else {
            query = "call addMarketOnClose(" + userBean.getSocialSecurityNumber() + ", " + num + ", '" + cal.getHourOfDay() + ":" + cal.getMinuteOfHour() + ":" + cal.getSecondOfMinute() +"'," + essn + "," + account + ", '" + ss + "', '" + cal.getYear() + "-" + cal.getMonthOfYear() + "-" + cal.getDayOfMonth() + "', 'buy');";
        }
        try {
        ResultSet res = CapitaBay.ExecuteQuery(query);
            ...
            query = "SELECT * FROM StockTable s WHERE s.StockSymbol = '" +ss+"';";
